...
<img src="Methodology/umap_scatter.png" width="500" height="400" />
...
<img src="Methodology/Rplot.png" width="400" height="300" />
...
kable(neighbor_points, escape = F) %>% 
  ...
  add_header_above(c(" "= 2, "Nutrition" = 2))
```
<img src="Methodology/Rplot01.png" width="450" height="300" />
